/**
 * ===============================================================================================
 * Printed Droid Teeces Logic Display Controller - ESP32 Enhanced Version 4.1
 * ===============================================================================================
 *
...
void setup() {
  ...
  Serial.println(F("\n╔══════════════════════════════════════════════════════════╗"));
  Serial.println(F("║     ESP32 Teeces v4.1 - Enhanced R2-D2 Controller       ║"));
  Serial.println(F("╚══════════════════════════════════════════════════════════╝"));
  Serial.println(F(""));
  Serial.println(F("NEW in v4.1:"));
  Serial.println(F("  ✨ Setup Wizard for first-time configuration"));
  Serial.println(F("  🔧 Hardware Diagnostics tool"));
  Serial.println(F("  ⚡ 5 Quick Presets (Bright, Dim, KT, Classic, Rainbow)"));
  Serial.println(F("  💡 Smart Suggestions with context-aware tips"));
  Serial.println(F("  ✓ Enhanced parameter validation with hints"));
  Serial.println(F(""));
...
void printFullHelp() {
  Serial.println(F("\n"));
  Serial.println(F("══════════════════════════════════════════════════════════"));
  Serial.println(F("                 TEECES v4.1 QUICK START"));
  Serial.println(F("══════════════════════════════════════════════════════════"));
  Serial.println(F(""));
  Serial.println(F("NEW IN v4.1:"));
